...
import 'bottom_sheet_route.dart' as BottomSheet;
...
class MaterialWithModalsPageRoute<T> extends MaterialPageRoute<T> {
  ...
  BottomSheet.ModalBottomSheetRoute? _nextModalRoute;
  ...
  bool canTransitionTo(TransitionRoute<dynamic> nextRoute) {
    ...
    return (nextRoute is MaterialPageRoute && !nextRoute.fullscreenDialog) ||
        ...
        (nextRoute is BottomSheet.ModalBottomSheetRoute);
  }

  @override
  void didChangeNext(Route? nextRoute) {
    if (nextRoute is BottomSheet.ModalBottomSheetRoute) {
